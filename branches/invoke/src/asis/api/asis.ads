...
private
   type Context is new Gela.Types.Context_Access;
   Nil_Context : constant Context := null;

   type Element is new Gela.Types.Element;
   Nil_Element : constant Element := (null, 0);

   Nil_Element_List : constant Element_List :=
     (1 .. 0 => (null, 0));

   type Compilation_Unit is new Gela.Types.Compilation_Unit;
   Nil_Compilation_Unit : constant Compilation_Unit := (null, 0);
