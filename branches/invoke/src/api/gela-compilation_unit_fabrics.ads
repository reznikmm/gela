...
package Gela.Compilation_Unit_Fabrics is
   pragma Preelaborate;

   type Compilation_Unit_Fabric is limited interface;
   type Compilation_Unit_Fabric_Access is
     access all Compilation_Unit_Fabric'Class;
   for Compilation_Unit_Fabric_Access'Storage_Size use 0;

   not overriding function Create_Library_Unit_Declaration
     (Self   : in out Compilation_Unit_Fabric;
...
end Gela.Compilation_Unit_Fabrics;
