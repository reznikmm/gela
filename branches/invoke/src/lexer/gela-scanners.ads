...
package Gela.Scanners is
   pragma Preelaborate;
   use Gela.Scanner_Types;

   subtype Token is Gela.Lexical_Types.Token_Kind;
   ...
   procedure Set_Handler
     (Self    : in out Scanner'Class;
      Handler : not null Gela.Scanner_Handlers.Handler_Access);
...
private
   ...
   type Scanner is tagged limited record
      Handler : Gela.Scanner_Handlers.Handler_Access;
      Source  : League.Strings.Universal_String;
