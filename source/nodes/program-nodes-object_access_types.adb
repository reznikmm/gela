...
package body Program.Nodes.Object_Access_Types is
   ...
   function Create
    (Not_Token          : Program.Lexical_Elements.Lexical_Element_Access;
     ...
     Subtype_Indication : not null Program.Elements.Subtype_Indications
      ...
      return Object_Access_Type is
   begin
      return Result : Object_Access_Type :=
   ...
   function Create
    (Subtype_Indication   : not null Program.Elements.Subtype_Indications
     ...
     Has_Constant         : Boolean := False)
      return Implicit_Object_Access_Type is
   begin
      return Result : Implicit_Object_Access_Type :=
   ...
   overriding function Has_All (Self : Object_Access_Type) return Boolean is
   begin
   ...
   procedure Initialize (Self : in out Base_Object_Access_Type'Class) is
   begin
