...
package body Program.Nodes.Generic_Package_Renaming_Declarations is
   ...
   function Create
    (Generic_Token   : not null Program.Lexical_Elements
     ...
     Semicolon_Token : not null Program.Lexical_Elements
         .Lexical_Element_Access)
      return Generic_Package_Renaming_Declaration is
   begin
      return Result : Generic_Package_Renaming_Declaration :=
   ...
   function Create
    (Name                 : not null Program.Elements.Defining_Names
     ...
     Is_Part_Of_Instance  : Boolean := False)
      return Implicit_Generic_Package_Renaming_Declaration is
   begin
      return Result : Implicit_Generic_Package_Renaming_Declaration :=
   ...
   begin
      Visitor.Generic_Package_Renaming_Declaration (Self);
   end Visit;
