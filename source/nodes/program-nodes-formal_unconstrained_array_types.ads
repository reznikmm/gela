...
package Program.Nodes.Formal_Unconstrained_Array_Types is
   ...
   type Formal_Unconstrained_Array_Type is
     new Program.Nodes.Node
         and Program.Elements.Formal_Unconstrained_Array_Types
           .Formal_Unconstrained_Array_Type
         and Program.Elements.Formal_Unconstrained_Array_Types
           .Formal_Unconstrained_Array_Type_Text
     with private;
   ...
   function Create
    (Array_Token          : not null Program.Lexical_Elements
     ...
     Component_Definition : not null Program.Elements.Component_Definitions
      ...
      return Formal_Unconstrained_Array_Type;

   type Implicit_Formal_Unconstrained_Array_Type is
     new Program.Nodes.Node
         and Program.Elements.Formal_Unconstrained_Array_Types
           .Formal_Unconstrained_Array_Type
     with private;
   ...
   function Create
    (Index_Subtypes       : not null Program.Elements.Expressions
     ...
     Is_Part_Of_Instance  : Boolean := False)
      return Implicit_Formal_Unconstrained_Array_Type
     with Pre =>
       Is_Part_Of_Implicit or Is_Part_Of_Inherited or Is_Part_Of_Instance;
private

   type Base_Formal_Unconstrained_Array_Type is
   ...
   type Formal_Unconstrained_Array_Type is
     new Base_Formal_Unconstrained_Array_Type
       and Program.Elements.Formal_Unconstrained_Array_Types
         .Formal_Unconstrained_Array_Type_Text
     with record
        Array_Token         : not null Program.Lexical_Elements
