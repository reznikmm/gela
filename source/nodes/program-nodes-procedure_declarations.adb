...
package body Program.Nodes.Procedure_Declarations is
   ...
   function Create
    (Not_Token           : Program.Lexical_Elements.Lexical_Element_Access;
     ...
     Semicolon_Token     : not null Program.Lexical_Elements
         .Lexical_Element_Access)
      return Procedure_Declaration is
   begin
      return Result : Procedure_Declaration :=
   ...
   function Create
    (Name                 : not null Program.Elements.Defining_Names
     ...
     Has_Abstract         : Boolean := False)
      return Implicit_Procedure_Declaration is
   begin
      return Result : Implicit_Procedure_Declaration :=
   ...
   overriding function Has_Not (Self : Procedure_Declaration) return Boolean is
   begin
   ...
   begin
      Visitor.Procedure_Declaration (Self);
   end Visit;
