...
package body Program.Nodes.Generic_Package_Declarations is
   ...
   function Create
    (Generic_Token        : not null Program.Lexical_Elements
     ...
     Semicolon_Token      : not null Program.Lexical_Elements
         .Lexical_Element_Access)
      return Generic_Package_Declaration is
   begin
      return Result : Generic_Package_Declaration :=
   ...
   function Create
    (Formal_Parameters    : Program.Element_Vectors.Element_Vector_Access;
     ...
     Is_Part_Of_Instance  : Boolean := False)
      return Implicit_Generic_Package_Declaration is
   begin
      return Result : Implicit_Generic_Package_Declaration :=
        (Formal_Parameters => Formal_Parameters, Name => Name,
         Aspects => Aspects, Visible_Declarations => Visible_Declarations,
   ...
   procedure Initialize
    (Self : in out Base_Generic_Package_Declaration'Class) is
   begin
   ...
   begin
      Visitor.Generic_Package_Declaration (Self);
   end Visit;
   ...
   overriding function To_Generic_Package_Declaration_Text
    (Self : in out Generic_Package_Declaration)
      return Program.Elements.Generic_Package_Declarations
          .Generic_Package_Declaration_Text_Access is
   begin
      return Self'Unchecked_Access;
   end To_Generic_Package_Declaration_Text;
