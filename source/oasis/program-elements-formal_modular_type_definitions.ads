...
package Program.Elements.Formal_Modular_Type_Definitions is
   ...
   pragma Pure (Program.Elements.Formal_Modular_Type_Definitions);
   ...
   type Formal_Modular_Type_Definition_Text is limited interface;

   type Formal_Modular_Type_Definition_Text_Access is
     access all Formal_Modular_Type_Definition_Text'Class
     with Storage_Size => 0;

   not overriding function To_Formal_Modular_Type_Definition_Text
    (Self : aliased Formal_Modular_Type_Definition)
      return Formal_Modular_Type_Definition_Text_Access is abstract;

   not overriding function Mod_Token
    (Self : Formal_Modular_Type_Definition_Text)
