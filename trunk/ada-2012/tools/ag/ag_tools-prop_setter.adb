...
package body AG_Tools.Prop_Setter is
   ...
   begin
      ...
      Spec.P;
      Spec.P ("package Gela.Property_Setters is");
      Spec.P ("   pragma Preelaborate;");
      Spec.P;
      Spec.P ("   type Property_Setter is limited interface;");
      Spec.P;
      ...
      Spec.P
        ("   type Visiter (V : not null access Property_Setter'Class) is");
      Spec.P ("     new Gela.Element_Visiters.Visiter with null record;");
      Spec.P;
      Spec.P ("private");

      Impl.P ("package body Gela.Property_Setters is");
         ...
         for Prod of G.Production (NT.First .. NT.Last) loop
            if AG_Tools.Input.Is_Concrete (NT.Index) and not NT.Is_List then
               ...
               loop
                  Impl.N ("      Self.V.On_");
                  Impl.N (To_Ada (Decl.Name));
                  Impl.N (" (Gela.Elements.Element_Access (Node), ");
                  Impl.N (To_Ada (Decl.Name));
                  Impl.P (");");
                  Impl.N ("      Node.Set_");
                  Impl.N (To_Ada (Decl.Name));
      ...
      Spec.P;
      Spec.P ("end Gela.Property_Setters;", Impl);
