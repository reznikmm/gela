...
package Gela.Property_Getters is
   pragma Preelaborate;

   type Getter is limited new Gela.Property_Visiters.Property_Visiter with
   record
      ...
      Type_Index    : Gela.Semantic_Types.Type_View_Index := 0;
